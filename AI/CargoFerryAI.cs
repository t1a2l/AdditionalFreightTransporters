...
namespace AdditionalFreightTransporters.AI
{
    public class CargoFerryAI : FerryAI
    {
        ...
        public override void SimulationStep(ushort vehicleID, ref Vehicle data, Vector3 physicsLodRefPos)
        {
            ...
            {
                if(data.m_transferSize < m_cargoCapacity && Utils.Settings.BargeWaitUntilFull.value == true)
                {
                    return;
                }
                bool flag = Singleton<SimulationManager>.instance.m_randomizer.Int32((uint)(Utils.Settings.DelayBarge.value * 4)) > 0;
