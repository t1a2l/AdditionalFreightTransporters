...
namespace AdditionalFreightTransporters.AI
{
    public class CargoHelicopterAI : PassengerHelicopterAI
    {
        ...
        private void LoadVehicle_HelicopterAI(ushort vehicleID, ref Vehicle data)
        {
        ...
        public override void SimulationStep(ushort vehicleID, ref Vehicle data, Vector3 physicsLodRefPos)
        {
            ...
            {
                bool flag = Singleton<SimulationManager>.instance.m_randomizer.Int32((uint)(Utils.Settings.DelayHelicopter.value * 4)) > 0;
