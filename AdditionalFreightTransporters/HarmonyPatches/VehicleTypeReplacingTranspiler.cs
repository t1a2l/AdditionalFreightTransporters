...
namespace AdditionalFreightTransporters.HarmonyPatches
{
    internal static class VehicleTypeReplacingTranspiler
    {
        ...
        {
            Debug.Log("AdditionalFreightTransporters: VehicleTypeReplacingTranspiler - Transpiling method: " + original.DeclaringType + "." + original);
            ...
            foreach (var codeInstruction in codes)
            {
                ...
                Debug.Log($"AdditionalFreightTransporters: VehicleTypeReplacingTranspiler - Replaced vehicle type with {newInstruction.operand}");
            }
