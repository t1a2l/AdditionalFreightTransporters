...
namespace AdditionalFreightTransporters.Attributes
{
    ...
    public class HideWhenNotInAssetEditorConditionAttribute : HideConditionAttribute
    {
        ...
        {
            return !SimulationManager.exists || SimulationManager.instance.m_metaData is not {m_updateMode: SimulationManager.UpdateMode.LoadAsset or SimulationManager.UpdateMode.NewAsset};
        }
    }
}