...
namespace AdditionalFreightTransporters.HarmonyPatches
{
    ...
    public static class PassengerHelicopterAIPatch
    {
        ...
        {
            return codeInstruction.opcode != OpCodes.Ldc_I4 || codeInstruction.operand == null || (!65796.Equals(codeInstruction.operand) && !150.Equals(codeInstruction.operand));
        }
