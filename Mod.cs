...
namespace AdditionalFreightTransporters
{
    public class Mod : IUserMod
    {
        ...
        public void OnSettingsUI(UIHelperBase helper)
        {
            ...
            m_sliderBarge = (UISlider)group.AddSlider($"Cargo Barges:", 1f, 10f, 1f, Utils.Settings.DelayBarge.value, ChangeSliderBarge);
            m_sliderBarge.width = 400f;
            m_sliderBarge.tooltip = Utils.Settings.DelayBarge.value.ToString() + "x";
            m_sliderHelicopter = (UISlider)group.AddSlider($"Cargo Helicopters:", 1f, 10f, 1f, Utils.Settings.DelayHelicopter.value, ChangeSliderHelicopter);
            m_sliderHelicopter.width = 400f;
            m_sliderHelicopter.tooltip = Utils.Settings.DelayHelicopter.value.ToString() + "x";

            group.AddCheckbox("Wait until a barge is Full befor sending away", Utils.Settings.BargeWaitUntilFull.value, (b) =>
            {
                Utils.Settings.BargeWaitUntilFull.value = b;
            });
        ...
        {
            Utils.Settings.DelayBarge.value = Convert.ToInt32(v);
        ...
        {
            Utils.Settings.DelayHelicopter.value = Convert.ToInt32(v);
