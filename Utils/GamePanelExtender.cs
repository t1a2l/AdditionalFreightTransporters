...
namespace AdditionalFreightTransporters.Utils
{
    public class GamePanelExtender : MonoBehaviour
    {
            ...
            if (!_initialized)
            {
                ...
                if (go != null)
                {
                    ...
                    if (infoPanel != null)
                    {
                        ...
                        _swapSprite = UiUtil.CreateSwapSptite(_cityServiceInfoPanel.component, CityServiceSwapHandler, new Vector3(162, 240));
                ...
                if (go1 != null)
                {
                    ...
                    if (infoPanel1 != null)
                    {
                        ...
                        _swapSprite1 = UiUtil.CreateSwapSptite(_warehouseWorldInfoPanel.component, WarehouseSwapHandler, new Vector3(162, 240));
                        _swapLabel1 = UiUtil.CreateLabel("Swap spawn and unspawn positions", _warehouseWorldInfoPanel.component, new Vector3(178, 240));
        ...
        {
            var instance = (InstanceID)Util.GetInstanceField(typeof(CityServiceWorldInfoPanel), _cityServiceInfoPanel, "m_InstanceID");
            var id = instance.Building;
            var data = Singleton<BuildingManager>.instance.m_buildings.m_buffer[id];
            var isCargoStation = Util.IsCargoStation(data);
        ...
        {
            var instance = (InstanceID)Util.GetInstanceField(typeof(WarehouseWorldInfoPanel), _warehouseWorldInfoPanel, "m_InstanceID");
            var id = instance.Building;
            var data = Singleton<BuildingManager>.instance.m_buildings.m_buffer[id];
            var isCargoStation = Util.IsCargoStation(data);
        ...
        {
            var instance = (InstanceID)Util.GetInstanceField(typeof(ZonedBuildingWorldInfoPanel), _cityServiceInfoPanel, "m_InstanceID");
            var id = instance.Building;
        ...
        {
            var instance = (InstanceID)Util.GetInstanceField(typeof(ZonedBuildingWorldInfoPanel), _warehouseWorldInfoPanel, "m_InstanceID");
            var id = instance.Building;
            Singleton<SimulationManager>.instance.AddAction(() =>
            {
                action.Invoke(id);
